...
# Deng_Ji = 工伤等级   SiFou_JieChu = 是否解除合同（1=是，2=否）  GongZhi_1 = 受伤前12个月平均工资

# ZhuYuan_TianShu = 住院天数   HuLi_TianShu = 护理天数   TingGongLiuXinQi_YueShu = 停工留薪期月数

# TingGongLiuXinQi_TianShu = 停工留薪期天数   TingGongLiuXinQi_ShiFaGongZhi = 停工留薪期实发工资

# GongZhi_2 = 解除劳动合同前12个月平均工资


def jsq(Deng_Ji, SiFou_JieChu, GongZhi_1, ZhuYuan_TianShu, HuLi_TianShu, TingGongLiuXinQi_YueShu,
    ...
    if (Deng_Ji+1) > 4:
        ...
        if (SiFou_JieChu == 2) and (Deng_Ji == 4 or Deng_Ji == 5):
