...
# 该程序中某些基数使用广州市相关标准（比如上年度职工平均工资），而且是2017年度的，各位使用时请根据所在地区及当年最新相关标准修改
...
while True:
    ...
    def Jishuan_Gongshi(Deng_Ji, SiFou_JieChu):
        ...
        YuePing_GongZhi = int('7425')   # 广州市2017年公布的上年度职工月平均工资
        ...
        if SiFou_JieChu == 1:
            ...
            if GongZhi_2 < YuePing_GongZhi * 0.6:
                ...
                print('\n解除劳动合同前12个月平均工资低于广州职工平均工资7425元的60%，即4455元！\n')
            elif GongZhi_2 > YuePing_GongZhi * 3:
                GongZhi_2 = YuePing_GongZhi * 3
                print('\n解除劳动合同前12个月平均工资高于广州职工平均工资7425元的300%，即22275元！\n')
